...
class GeneralController extends GetxController {
    ...
    /* 메인컬러 정의 */
    var MainColor = Color(0xff9966ff); // 앱 전반적으로 사용될 메인 컬러 # 0xFF9966ff
    var BlueColor = Color(0xff536dfe); // 블루계열 색상 # 0xff2196f3 # 0xff2196f3 # 0xff2979ff

    /* 모달창 텍스트 스타일 */
    var TextStyle_normal_accent = TextStyle(fontSize: 20, color: Colors.black, fontWeight: FontWeight.w900); // 일반적인 텍스트 스타일 정의
    var TextStyle_normal_disable = TextStyle(fontSize: 20, color: Colors.grey, fontWeight: FontWeight.w300); // 일반적인 텍스트 스타일 정의
