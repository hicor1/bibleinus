              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      // 이전페이지
                      IconButton(icon: Icon(Elusive.left_open, color: Colors.black54),
                        ...
                        child: Column(
                          children: [
                            ...
                            Text(
                              ...
                              style: TextStyle(color: Colors.black54, fontSize: GeneralCtr.fontsize_normal),
                            ),
                          ],
                        ),
                        onPressed: () {
                      ...
                      // 다음페이지
                      IconButton(icon: Icon(Elusive.right_open, color: Colors.black54),
              ...
              child: Column(
                children: [
                  ...
                  IconButton(
                    ...
                    icon: Icon(Entypo.down_open_mini,size: 30),
